...
require (
	...
	intel/isecl/lib/verifier/v3 v3.1.0
	intel/isecl/lib/vml/v3 v3.1.0
)

replace intel/isecl/lib/tpmprovider/v3 => github.com/intel-secl/tpm-provider/v3 v3.1.0

replace intel/isecl/lib/vml/v3 => github.com/intel-secl/volume-management-library/v3 v3.1.0
...
replace intel/isecl/lib/verifier/v3 => github.com/intel-secl/verifier/v3 v3.1.0
