...
replace intel/isecl/lib/vml/v3 => github.com/intel-secl/volume-management-library/v3 v3.3.0
...
replace intel/isecl/lib/verifier/v3 => github.com/intel-secl/verifier/v3 v3.3.0
