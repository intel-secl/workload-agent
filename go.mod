...
replace intel/isecl/lib/tpm => github.com/intel-secl/tpm v1.6.0

replace intel/isecl/lib/vml => github.com/intel-secl/volume-management-library v1.6.0
...
replace intel/isecl/lib/verifier => github.com/intel-secl/verifier v1.6.0

replace intel/isecl/lib/platform-info => github.com/intel-secl/platform-info v1.6.0
