...
replace (
	...
	intel/isecl/lib/platform-info/v4 => gitlab.devtools.intel.com/sst/isecl/lib/platform-info.git/v4 v4.2/develop
	...
	intel/isecl/lib/vml/v4 => gitlab.devtools.intel.com/sst/isecl/lib/volume-management.git/v4 v4.2/develop
