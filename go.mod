...
replace (
	...
	intel/isecl/lib/platform-info/v4 => gitlab.devtools.intel.com/sst/isecl/lib/platform-info.git/v4 v4.1/develop
	intel/isecl/lib/tpmprovider/v4 => gitlab.devtools.intel.com/sst/isecl/lib/tpm-provider.git/v4 v4.1/develop
	intel/isecl/lib/verifier/v4 =>  gitlab.devtools.intel.com/sst/isecl/lib/verifier.git/v4 v4.1/develop
	intel/isecl/lib/vml/v4 => gitlab.devtools.intel.com/sst/isecl/lib/volume-management.git/v4 v4.1/develop
