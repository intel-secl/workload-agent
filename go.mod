...
replace (
	...
	intel/isecl/lib/platform-info/v4 => github.com/intel-secl/platform-info/v4 v4.0.1
	...
	intel/isecl/lib/vml/v4 => github.com/intel-secl/volume-management-library/v4 v4.0.1
)
