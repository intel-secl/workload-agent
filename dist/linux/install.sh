...
required_vars="MTWILSON_API_URL WLS_API_URL WLA_USERNAME WLA_PASSWORD TRUSTAGENT_CONFIGURATION TRUSTAGENT_USERNAME CMS_TLS_CERT_SHA384 AAS_API_URL CMS_BASE_URL"
